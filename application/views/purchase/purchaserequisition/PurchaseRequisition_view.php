...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        ...
        <div class="row">
            ...
            <h1>Send Purchase Requisition</h1>
        </div>
      <hr>
                        <form role="form" id="Form" action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group mb-3">
                                    <label for="BranchName"style="color:black;">Branch Name<span class="text-danger">*</span></label>
                                    <input class="form-control" id="BranchName" type="text"
                                        name="BranchName" value="<?php if (!empty($data))
                                ...
                                <div class="col-md-3 form-group mb-3">
                                    <label for="ToBranchName">To Branch Name<span class="text-danger">*</span></label>
                                    <select class="form-control"  name="ToBranchName" id="ToBranchName">
                                ...
                                <div class="col-md-2 form-group mb-3">
                                    <label for="ExpectedDate">Expected Date<span class="text-danger">*</span></label>
                                    <input class="form-control" id="ExpectedDate" type="date"
                                     name="ExpectedDate" value="<?php echo date('Y-m-d');?>" />
                                </div>

                                <div class="col-md-4 form-group mb-3">
                                            <label for="EmployeeName">Employee Name<span class="text-danger">*</span></label>
                                            <textarea class="form-control" id="EmployeeName" type="text" name="EmployeeName" value=""></textarea>
                                        </div>
                                ...
                                <div class="row">
                                <div class="col-md-4 form-group mb-3 m-3">
