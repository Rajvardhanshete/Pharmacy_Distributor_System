        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <h1>Get-Pass Details</h1>
                    
                    <button class="btn btn-primary" ><a href="<?=base_url() ?>frontoffice/Pass/create" class="text-white text-decoration-none"><i class="fa-solid fa-plus text-white"></i>&nbsp;Add New</a></button>
                                 </div>
                                 <hr>
