                        ...
                        <form role="form" id="Form" action="" method="post">
                            <div class="row">
                                <div class="col-md-3 form-group mb-3">
                                    ...
                                    <input class="form-control" id="BranchName" type="text" name="BranchName"
                                        value="" />
                                </div>
                                <div class="col-md-3 form-group mb-3">
                                ...
                                <div class="col-md-3 form-group mb-3">
                                    <label for="Message">Reference Name</label>
                                    <input class="form-control" id="ReferenceName" type="text" name="ReferenceName"
                                        value="" />
                                </div>
                            ...
                            <!-- <div class="row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <a class="btn btn-warning "style="font-weight:900;" href="<?= base_url() ?>frontoffice/Staff/index"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <button class="btn btn-danger text-white" type="button" name="cancel" id="cancel" style="color:white;background-color:red;font-weight:500;box-shadow: 1px 2px 3px 0px black;"><a class="text-white" href="http://localhost/ProjectTemplate1/frontoffice/Staffe/create"><i class="fa-regular fa-circle-xmark"></i>&nbsp; Cancel</a></button>
...
// Check if no gender is selected
        ...
        if (BranchName === "" || EmployeeName === "" ||Message=="" || Date === "" || ReferenceType === "" || ReferenceName === "") {
            ...
            $.ajax({
                url: base_path + "FrontOffice/staff/insertSTAFF",
                type: "POST",
                data: $('#Form').serialize(),
                beforeSend: function(){
