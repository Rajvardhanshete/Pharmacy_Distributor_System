        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <h1>Postal Recieve Details</h1>
                    <button class="btn btn-primary"><a href="<?=base_url() ?>frontoffice/Postalrecieve/create" class="text-white text-decoration-none"><i class="fa-solid fa-plus text-white"></i>&nbsp;Add New</a></button>
                </div>
                <hr>
                                   ...
                                   <table class="display table table-striped table-bordered" id="example" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Place</th>
                                                <th>Address</th>
                                                <th>In No Referenceress</th>
                                                <th>In Date Reference</th>
                                                <th>Subject Of Corres</th>
                                                <th>Remark</th>
