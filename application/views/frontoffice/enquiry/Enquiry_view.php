        ...
        <hr>
                        ...
                        <div class="row">
                                        ...
                                        <label for="ReferenceType">Reference Type</label>
                                            ...
                                            <option value="<?= isset($data->ReferenceType)? $data->ReferenceType:''?>">-Select-</option>
                                    ...
                                    <textarea class="form-control" id="EnquiryReason" type="text" name="EnquiryReason" value="<?= isset($data->EnquiryReason)? $data->EnquiryReason:''?>">
                                    </textarea>
                                </div>
                                    </div>
