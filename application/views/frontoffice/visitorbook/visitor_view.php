        ...
        <hr>
                        ...
                        <div class="row">
                                        <div class="col-md-4 form-group mb-3">
                                            ...
                                            <input class="form-control" id="VisitorName" type="text"name="VisitorName" value=""/>
                                        </div>
                                    ...
                                    <input class="form-control" type="date" id="date" name="date"
                                      ...
                                      <div class="col-md-2 form-group mb-3">
                                            ...
                                            <input class="form-control" id="TimeIn" type="time" name="TimeIn" value=""/>
                                        </div>
                                        <div class="col-md-2 form-group mb-3">
                                            <label for="TimeOut"> Time-Out</label>
                                            <input class="form-control" id="TimeOut" type="time" name="TimeOut" value=""/>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group mb-3">
                                        <label for="Reasone">Reasone</label>
                                        <textarea class="form-control" id="Reasone" type="" name="Reasone"
                                        value=""></textarea>
                                ...
                                <div class="col-md-12 text-right">
                                    ...
                                    <a class="btn btn-warning  "style="font-weight:900; color:black;" href="<?= base_url() ?>frontoffice/visitor/index"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <button class="btn btn-danger text-white" type="button" name="cancel" id="cancel" style="color:white;background-color:red;font-weight:500;box-shadow: 1px 2px 3px 0px black;"><a class="text-white" href="http://localhost/ProjectTemplate1/frontoffice/visitorbook/create"><i class="fa-regular fa-circle-xmark"></i>&nbsp; Cancel</a></button>
...
// Check if no gender is selected
        ...
        if (VisitorName === "" || date === "" ||TimeIn=="0" || TimeOut === "" || Address === "" || Reasone === "") {
            ...
            $.ajax({
                url: base_path + "FrontOffice/visitor/insertVisit",
                type: "POST",
                data: $('#Form').serialize(),
                beforeSend: function(){
