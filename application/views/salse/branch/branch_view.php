        ...
        <hr>
                        ...
                        <div class="row">
                                <div class="col-md-3 form-group mb-3">
                                    <label for="branchName">Bank Branch Name<span style="color:red;">*</span></label>
                                    <input class="form-control" id="branchName" type="text" name="branchName"
                                        value="" />
                                </div>

                                <div class="col-md-3 form-group mb-3">
                                    <label for="mainName">Main Bank Name<span style="color:red;">*</span></label>
                                    <input class="form-control" id="mainName" type="text" name="mainName"
                                        value="" />
                                </div>
                              
                               
                                <div class="col-md-3 form-group mb-3">
                                    <label for="branchcode">Branch Bank Code<span style="color:red;">*</span></label>
                                    <input class="form-control" id="branchcode" type="text" name="branchcode"
                                        value="" />
                                </div>

                                <div class="col-md-3 form-group mb-3">
                                    <label for="IFSCcode">IFSC Code<span style="color:red;">*</span></label>
                                    <input class="form-control" id="IFSCcode" type="text" name="IFSCcode"
                                        value="" />
                                </div>
                                ...
                                <div class="col-md-3 form-group mb-3">
                                    <label for="MICRcode">MICR Code<span style="color:red;">*</span></label>
                                    <input class="form-control" id="MICRcode" type="text" name="MICRcode"
                                        value="" />
                                </div>
