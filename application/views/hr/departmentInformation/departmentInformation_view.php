                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form role="form" id="Form" action="" method="post">
                            <div class="h3 text-left">Department Information</div>
                            <div class="row">

                                <div class="col-md-3 form-group mb-3">
                                    <label for="DepartmentName">Department Name <span class="text-danger">*</span></label>
                                    <input class="form-control" id="DepartmentName" type="text" name="DepartmentName" placeholder="Enter Department Name" required />
                                </div>
