                    ...
                    <form role="form" id="Form" action="" method="post">
                        ...
                        <div class="col-md-4 form-group mb-3">
                                ...
                                <div class="col-md-2 form-group mb-3">
                                            ...
                                            <input class="form-control" type="date" id="MaintenanceDate" name="MaintenanceDate" value="<?php echo date('Y-m-d');?>"/>
                                </div>

                                <div class="col-md-2 form-group mb-3">
                                            <label for="NextMaintenanceDate">NextMaintenanceDate</label>
                                            <input class="form-control" type="date" id="NextMaintenanceDate" name="NextMaintenanceDate" value="<?php echo date('Y-m-d');?>"/>
                                </div>
