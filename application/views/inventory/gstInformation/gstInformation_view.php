                        ...
                        <form role="form" id="Form" action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 form-group mb-3">
                                    ...
                                    <input class="form-control" id="GSTName" type="text" name="GSTName" placeholder="Enter GST Name" required />
                                </div>

                                <div class="col-md-2 form-group mb-3">
                                    <label for="GSTShortName">GST Short Name <span class="text-danger">*</span></label>
                                    <input class="form-control" id="GSTShortName" type="text" name="GSTShortName" placeholder="Enter Short Name" required />
                                </div>

                                <div class="col-md-2 form-group mb-3">
                                    <label for="GSTPercentage">GST Percentage Value <span class="text-danger">*</span></label>
                                    <input class="form-control" id="GSTPercentage" type="text" name="GSTPercentage" placeholder="Enter GST Percentage Value" required />
                                </div>

                                <div class="col-md-2 form-group mb-3">
                                    <label for="IGSTValue">IGST Value <span class="text-danger">*</span></label>
                                    <input class="form-control" id="IGSTValue" type="text" name="IGSTValue" placeholder="00.00" required />
                                </div>

                                <div class="col-md-2 form-group mb-3">
                                    <label for="CGSTValue">CGST Value <span class="text-danger">*</span></label>
                                    <input class="form-control" id="CGSTValue" type="text" name="CGSTValue" placeholder="00.00" required />
                                </div>

                                <div class="col-md-2 form-group mb-3">
                                    <label for="SGSTValue">SGST Value <span class="text-danger">*</span></label>
                                    <input class="form-control" id="SGSTValue" type="text" name="SGSTValue" placeholder="00.00" required />
                                </div>
