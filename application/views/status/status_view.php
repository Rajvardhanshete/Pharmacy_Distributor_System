                        ...
                        <form role="form" id="Form" action="" method="post">
                            <div class="row">
                                <div class="col-md-3 form-group mb-3">
                                    ...
                                    <input class="form-control" id="StatusName" type="text" name="StatusName"
                                        value="" />
                                </div>
                                <div class="col-md-2 form-group mb-3">
                                    <label for="Colorcode"> Colorcode <span style="color:red;">*</span></label>
                                    <input class="form-control" id="Colorcode" type="color" name="Colorcode"
                                        value="" />
                                </div>
