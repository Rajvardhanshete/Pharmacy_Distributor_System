...
class PurchaseRequisition extends CI_Controller {
	...
	{
		// $data['alldata']=$this->Pass_model->getallPass();

        // echo "<pre>";
        // print_r($data);

		$this->load->view('common/header_view');
		$this->load->view('purchaserequisition/PurchaseRequisition_detail');
    ...
    public function create()
	{
		...
		$this->load->view('common/header_view');
		$this->load->view('purchase/purchaserequisition/PurchaseRequisition_view');
        $this->load->view('common/footer_view');
	}
	function insertPass(){
       ...
       $fields=array('PersonName'=>$PersonName,
        ...
        //      'created_by'=>1
            ...
            $this->Pass_model->insertdata($fields);
